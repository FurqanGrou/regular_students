...
Route::group(['middleware' => [ 'web' => 'auth:admin' ], 'as' => 'dashboard.'], function()
{
    ...
    Route::get('/importCustomPrices', [ImportExportController::class, 'importCustomPrices'])->name('import.custom.prices.view');
    Route::post('/importCustomPrices', [ImportExportController::class, 'importCustomPricesStore'])->name('import.custom.prices.store');

    Route::get('/reset-custom-prices', [ImportExportController::class, 'resetCustomPrices'])->name('reset-custom-prices');
});
